function dropdown1() {
  if (active1 == 0) {
    document.getElementById("drop-img1").style.rotate = "0deg";
...
function dropdown2() {
  if (active2 == 0) {
    document.getElementById("drop-img2").style.rotate = "0deg";
    document.getElementById("drop2").style.backgroundColor = "#e57f845e";
    document.getElementById("sub2").style.display = "block";
    active2++;
  } else {
    active2 = 0;
    document.getElementById("drop-img2").style.rotate = "90deg";
