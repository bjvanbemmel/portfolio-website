...
<body class="flex flex-col justify-center items-center text-center dark:bg-zinc-900 dark:text-zinc-200 p-4 bg-zinc-100 text-zinc-900">
    ...
    <ul class="list-none flex flex-row">
        ...
        <li class="m-2 underline font-semibold"><a target="__BLANK" title="My LinkedIn profile" href="https://linkedin.com/in/beau-jean-van-bemmel">LinkedIn</a></li>
        <li class="m-2 underline font-semibold"><a target="__BLANK" title="My Curriculum Vitae" href="cv">CV</a></li>
    </ul>
</body>
